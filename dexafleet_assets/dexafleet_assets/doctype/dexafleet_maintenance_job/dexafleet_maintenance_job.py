...
from dexafleet_assets.utils import money_equal, validate_company_access


class DexaFleetMaintenanceJob(Document):
    def validate(self):
    ...
    def before_submit(self):
        ...
        if "DexaFleet Company Admin" not in frappe.get_roles() and "System Manager" not in frappe.get_roles():
            frappe.throw(_("Only DexaFleet Company Admin can approve and submit a maintenance bill."))
    ...
    def _validate_links(self):
        ...
        self.current_rider = frappe.db.get_value("Asset", self.asset, "dexafleet_current_rider")
